            ...
            {workHistory.map(job => (
                <article
                    ...
                    <div className="px-0 md:px-7  ">
                        ...
                        <p className="uppercase text-sm sm:text-base py-3 text-gray-500 ml-2">
                            {" "}
                            Started work {job.startDate} - {job.endDate}
                        </p>

                        <ul className="list-dic space-y-2 mx-2 sm:p-[6px] md:p-[3px] lg:p-[1px] text-[11px] md:text-base ">
