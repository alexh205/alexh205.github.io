...
const About = (props: Props) => {
    return (
        <motion.div
            ...
            className="flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly md:justify-center max-auto items-center ">
            <h3 className="absolute sm:top-24 top-[90px] uppercase tracking-[20px] text-gray-500 text-2xl">
                about
            </h3>
            <motion.img
                initial={{
                ...
                className="-mb-28 md:mb-0 flex-shrink-0 w-48 h-48 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[500px] xl:h-[600px]"
            />
